...
from koalified.types import (string_boolean, number, floating_number, string, match, ip, one_of, date, date_time,
                             strict_date, strict_datetime, postal, country, phonenumber)
...
def test_ip():
    assert ip('2001:cdba:0000:0000:0000:0000:3257:9652') == ip_address('2001:cdba:0000:0000:0000:0000:3257:9652')
